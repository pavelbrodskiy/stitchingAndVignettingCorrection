...
%% Inputs
% Stitching Inputs
inputDirectory = 'C:\Users\Paul\Documents\LAB\01.28.15\wt DCP\'; % The full directory of raw data
...
fileName = 'wt DCP 1.28 '; % FILENAME of input file
numChars = 4; % Number of characters in the file index (ei 00001)
tiles = 256; % Total number of tiles in folder
colors = {'640', '488', '561', '405'}; % Channels in order of red->green->blue->white
channels = {'488', '405', '561', '640'}; % Channels in order of name-number (ie w1, w2)
M = '8'; % Number of columns in montage
N = '8'; % Number of rows in montage
numembs = 4; % This is important, number of stitched embryos (should be tiles/M/N)
overlap = '37'; % Percentage of overlap in he tiles
outputNumber = 1; % Starting index of the final stitched image
outputName = '2015.01.28 wt DCP '; % Name of the final stitched image
doVignettingCorrection = false; % Should we do FFT and normalization?
...
if doVignettingCorrection
    ...
    chan = [488 405 561 640];
    start = 1; % Index of first tile
    filename = 'wt DCP 1.28 ';
...
%% Initialize
addpath('C:\Users\Paul\Downloads\fiji-win64\scripts');
Miji(false);
mkdir(tempDirectory);
